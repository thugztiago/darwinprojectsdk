...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FOptimusGraphVariableDescription> Variables;                                       // 0x0030(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	TSet<class FName>                             ExpandedPins;                                      // 0x0060(0x0050)(ZeroConstructor, NonTransactional, NativeAccessSpecifierPrivate)
...
{
public:
	class FName                                   Category;                                          // 0x0208(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   KernelName;                                        // 0x0210(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FOptimusExecutionDomain                ExecutionDomain;                                   // 0x0218(0x0020)(NativeAccessSpecifierPublic)
...
{
public:
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0208(0x0030)(NativeAccessSpecifierPublic)
...
{
public:
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0208(0x0030)(NativeAccessSpecifierPrivate)
