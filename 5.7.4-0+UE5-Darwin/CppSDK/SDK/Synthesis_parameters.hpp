...
{
public:
	TSet<class USoundModulatorBase*>              InModulators;                                      // 0x0000(0x0050)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FSourceEffectBitCrusherSettings        ModulationSettings;                                // 0x0000(0x00B0)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FSourceEffectDynamicsProcessorSettings InSettings;                                        // 0x0000(0x002C)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
