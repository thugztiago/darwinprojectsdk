...
{
public:
	int32                                         JitterLatencyFrames;                               // 0x08B0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8B4[0xBC];                                     // 0x08B4(0x00BC)(Fixing Struct Size After Last Property [ Dumper-7 ])
