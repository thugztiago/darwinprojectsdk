...
public:
	...
	TMulticastInlineDelegate<void(const class UEnhancedInputUserSettings* Settings)> OnPostUserSettingsInitialized; // 0x01B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UEnhancedInputUserSettings*             UserSettings;                                      // 0x01C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	TMap<class UInputAction*, struct FInjectedInput> ContinuouslyInjectedInputs;                     // 0x01C8(0x0050)(Transient, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	class UEnhancedPlayerInput*                   PlayerInput;                                       // 0x0188(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	uint8                                         Pad_190[0x10];                                     // 0x0190(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TWeakObjectPtr<class UInputComponent>> CurrentInputStack;                                 // 0x01A0(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TMap<class UInputAction*, struct FInjectedInput> ContinuouslyInjectedInputs;                     // 0x01B0(0x0050)(Transient, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	TSet<class UInputAction*>                     ConsumedInputActions;                              // 0x0538(0x0050)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	TMap<class UInputMappingContext*, struct FAppliedInputContextData> AppliedInputContextData;      // 0x0588(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<class UInputMappingContext*, int32>      AppliedInputContexts;                              // 0x05D8(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TArray<struct FEnhancedActionKeyMapping>      EnhancedActionMappings;                            // 0x0628(0x0010)(ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	struct FGameplayTagContainer                  CurrentInputMode;                                  // 0x0638(0x0020)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_658[0x140];                                    // 0x0658(0x0140)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FKey, struct FVector>             KeysPressedThisTick;                               // 0x0798(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<class UInputAction*, struct FInjectedInputArray> InputsInjectedThisTick;                    // 0x07E8(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TSet<class UInputAction*>                     LastInjectedActions;                               // 0x0838(0x0050)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	TArray<struct FEnhancedActionKeyMapping>      Mappings;                                          // 0x0030(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FInputMappingContextMappingData        DefaultKeyMappings;                                // 0x0040(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, Config, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TMap<class FString, struct FInputMappingContextMappingData> MappingProfileOverrides;             // 0x0050(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, Config, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	EMappingContextInputModeFilterOptions         InputModeFilterOptions;                            // 0x00A0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_A1[0x7];                                       // 0x00A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagQuery                      InputModeQueryOverride;                            // 0x00A8(0x0048)(Edit, BlueprintVisible, BlueprintReadOnly, Config, Protected, NativeAccessSpecifierProtected)
	EMappingContextRegistrationTrackingMode       RegistrationTrackingMode;                          // 0x00F0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_F1[0x7];                                       // 0x00F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   ContextDescription;                                // 0x00F8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
...
public:
	...
	TMulticastInlineDelegate<void(const class UEnhancedPlayerMappableKeyProfile* NewProfile)> OnKeyProfileChanged; // 0x0050(0x0010)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	TSet<class UInputMappingContext*>             RegisteredMappingContexts;                         // 0x0130(0x0050)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
