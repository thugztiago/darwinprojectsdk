...
struct CrosshairFreeCam_C_EventUpdateSpeedMultiplier final
{
public:
...
DUMPER7_ASSERTS_CrosshairFreeCam_C_EventUpdateSpeedMultiplier;

// Function CrosshairFreeCam.CrosshairFreeCam_C.ExecuteUbergraph_CrosshairFreeCam
// 0x00B8 (0x00B8 - 0x0000)
struct CrosshairFreeCam_C_ExecuteUbergraph_CrosshairFreeCam final
{
public:
	...
	struct FVector2D                              CallFunc_MakeVector2D_ReturnValue_3;               // 0x00A0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_NormalizeToRange_Value_ImplicitCast;      // 0x00B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_CrosshairFreeCam_C_ExecuteUbergraph_CrosshairFreeCam;
