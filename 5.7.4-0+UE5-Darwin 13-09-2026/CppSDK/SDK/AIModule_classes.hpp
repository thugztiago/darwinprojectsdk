...
public:
	...
	uint8                                         bStartAILogicOnPossess : 1;                        // 0x0380(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bStopAILogicOnUnposses : 1;                        // 0x0380(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bLOSflag : 1;                                      // 0x0380(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSkipExtraLOSChecks : 1;                           // 0x0380(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAllowStrafe : 1;                                  // 0x0380(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bWantsPlayerState : 1;                             // 0x0380(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSetControlRotationFromPawnOrientation : 1;        // 0x0380(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_381[0x7];                                      // 0x0381(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPathFollowingComponent*                PathFollowingComponent;                            // 0x0388(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	class UBrainComponent*                        BrainComponent;                                    // 0x0390(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class UAIPerceptionComponent*                 PerceptionComponent;                               // 0x0398(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class UBlackboardComponent*                   Blackboard;                                        // 0x03A0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	class UGameplayTasksComponent*                CachedGameplayTasksComponent;                      // 0x03A8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	...
	TMulticastInlineDelegate<void(const struct FAIRequestID& RequestID, EPathFollowingResult Result)> ReceiveMoveCompleted; // 0x03B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	class UAISystem*                              AISystem;                                          // 0x0030(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	class UBehaviorTreeManager*                   BehaviorTreeManager;                               // 0x0108(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	class UEnvQueryManager*                       EnvironmentQueryManager;                           // 0x0110(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	class UAIPerceptionSystem*                    PerceptionSystem;                                  // 0x0118(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	TArray<class UAIAsyncTaskBlueprintProxy*>     AllProxyObjects;                                   // 0x0120(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	class UAIHotSpotManager*                      HotSpotManager;                                    // 0x0130(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	class UNavLocalGridManager*                   NavLocalGrids;                                     // 0x0138(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UBTCompositeNode*                       RootNode;                                          // 0x0030(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class UBlackboardData*                        BlackboardAsset;                                   // 0x0038(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	TArray<class UBTDecorator*>                   RootDecorators;                                    // 0x0040(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
...
public:
	...
	class UBlackboardComponent*                   BlackboardComp;                                    // 0x00C8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	...
	TArray<class UBTNode*>                        NodeInstances;                                     // 0x0138(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	uint8                                         Pad_148[0x148];                                    // 0x0148(0x0148)(Fixing Size After Last Property [ Dumper-7 ])
	class UBehaviorTree*                          DefaultBehaviorTreeAsset;                          // 0x0290(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	...
	TArray<class UBehaviorTreeComponent*>         ActiveComponents;                                  // 0x0040(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
...
{
public:
	class UBrainComponent*                        BrainComp;                                         // 0x00C0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	class UBlackboardData*                        DefaultBlackboardAsset;                            // 0x00C8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	class UBlackboardData*                        BlackboardAsset;                                   // 0x00D0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	uint8                                         Pad_D8[0x20];                                      // 0x00D8(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UBlackboardKeyType*>             KeyInstances;                                      // 0x00F8(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
...
{
public:
	class UBlackboardData*                        Parent;                                            // 0x0030(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
{
public:
	TSubclassOf<class UObject>                    BaseClass;                                         // 0x0030(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoClear, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	TSubclassOf<class UObject>                    DefaultValue;                                      // 0x0038(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
{
public:
	class UEnum*                                  EnumType;                                          // 0x0030(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	...
	uint8                                         DefaultValue;                                      // 0x0048(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_49[0x3];                                       // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bIsEnumNameValid : 1;                              // 0x004C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, DisableEditOnInstance, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
class UGeneratedNavLinksProxy final : public UBaseGeneratedNavLinksProxy
{
public:
	TMulticastInlineDelegate<void(class AActor* MovingActor, const struct FVector& DestinationPoint)> OnSmartLinkReached; // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"GeneratedNavLinksProxy")
	}
	static class UGeneratedNavLinksProxy* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGeneratedNavLinksProxy>();
	}
};
DUMPER7_ASSERTS_UGeneratedNavLinksProxy;
...
{
public:
	class FName                                   DefaultValue;                                      // 0x0030(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class UEnum*                                  EnumType;                                          // 0x0040(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
public:
	...
	class UAIPerceptionSystem*                    PerceptionSystemInstance;                          // 0x0030(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	TSubclassOf<class UObject>                    BaseClass;                                         // 0x0030(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoClear, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class UObject*                                DefaultValue;                                      // 0x0038(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
{
public:
	struct FInstancedStruct                       DefaultValue;                                      // 0x0030(0x0010)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FInstancedStruct                       Value;                                             // 0x0040(0x0010)(Transient, Protected, NativeAccessSpecifierProtected)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("BlackboardKeyType_Struct")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BlackboardKeyType_Struct")
	}
...
DUMPER7_ASSERTS_UBlackboardKeyType_Struct;
...
public:
	...
	class UNavMovementComponent*                  MovementComp;                                      // 0x00F8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	uint8                                         Pad_100[0x20];                                     // 0x0100(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	class ANavigationData*                        MyNavData;                                         // 0x0120(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	uint8                                         Pad_128[0x1E8];                                    // 0x0128(0x01E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	struct FVector                                CrowdAgentMoveDirection;                           // 0x0328(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class UBehaviorTree*                          TreeAsset;                                         // 0x0040(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	class UBTCompositeNode*                       ParentNode;                                        // 0x0048(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	uint16                                        ExecutionIndex;                                    // 0x0050(0x0002)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint16                                        MemoryOffset;                                      // 0x0052(0x0002)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         TreeDepth;                                         // 0x0054(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bIsInstanced : 1;                                  // 0x0055(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bIsInjected : 1;                                   // 0x0055(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bCreateNodeInstance : 1;                           // 0x0055(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bOwnsGameplayTasks : 1;                            // 0x0055(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
public:
	...
	TArray<class UBTService*>                     Services;                                          // 0x0068(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
...
{
public:
	TArray<class UBTService*>                     Services;                                          // 0x0058(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
...
public:
	...
	uint8                                         Pad_17D[0x2B];                                     // 0x017D(0x002B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	class AActor*                                 ActorOwner;                                        // 0x0070(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
{
public:
	struct FValueOrBBKey_Float                    ConeHalfAngle;                                     // 0x0068(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FBlackboardKeySelector                 ConeOrigin;                                        // 0x0078(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FBlackboardKeySelector                 ConeDirection;                                     // 0x00A0(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FBlackboardKeySelector                 Observed;                                          // 0x00C8(0x0028)(Edit, NativeAccessSpecifierPublic)
...
{
public:
	class AAIController*                          OwnerController;                                   // 0x0068(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
{
public:
	struct FValueOrBBKey_Float                    CoolDownTime;                                      // 0x0068(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	struct FValueOrBBKey_Enum                     PathQueryType;                                     // 0x00C0(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FValueOrBBKey_Class                    FilterClass;                                       // 0x00E8(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_D5[0x3];                                       // 0x00D5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FValueOrBBKey_Bool                     bUseNavAgentGoalLocation;                          // 0x00D8(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	struct FValueOrBBKey_Class                    TestClass;                                         // 0x0090(0x0020)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
public:
	struct FValueOrBBKey_Float                    ConeHalfAngle;                                     // 0x0068(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FBlackboardKeySelector                 ConeOrigin;                                        // 0x0078(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FBlackboardKeySelector                 Observed;                                          // 0x00A0(0x0028)(Edit, NativeAccessSpecifierPublic)
	uint8                                         bUseSelfAsOrigin : 1;                              // 0x00C8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUseSelfAsObserved : 1;                            // 0x00C8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
{
public:
	struct FValueOrBBKey_Int32                    NumLoops;                                          // 0x0068(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FValueOrBBKey_Float                    InfiniteLoopTimeoutTime;                           // 0x007C(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
// Class AIModule.BTDecorator_LoopUntil
// 0x0028 (0x0090 - 0x0068)
class UBTDecorator_LoopUntil final : public UBTDecorator
{
public:
	struct FValueOrBBKey_Enum                     RequiredResult;                                    // 0x0068(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BTDecorator_LoopUntil")
	}
	static class UBTDecorator_LoopUntil* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBTDecorator_LoopUntil>();
	}
};
DUMPER7_ASSERTS_UBTDecorator_LoopUntil;
...
public:
	...
	struct FValueOrBBKey_Float                    CooldownDuration;                                  // 0x0070(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	struct FValueOrBBKey_Float                    TimeLimit;                                         // 0x0068(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	class AActor*                                 ActorOwner;                                        // 0x0078(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
{
public:
	struct FValueOrBBKey_Bool                     bWaitForGameplayTask;                              // 0x0070(0x0010)(Edit, NoDestructor, AdvancedDisplay, Protected, NativeAccessSpecifierProtected)
...
{
public:
	struct FValueOrBBKey_Float                    Loudnes;                                           // 0x0070(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	struct FValueOrBBKey_Float                    AcceptableRadius;                                  // 0x0098(0x0010)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
	struct FValueOrBBKey_Class                    FilterClass;                                       // 0x00A8(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FValueOrBBKey_Bool                     bAllowPartialPath;                                 // 0x00E8(0x0010)(Edit, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FValueOrBBKey_Bool                     bTrackMovingGoal;                                  // 0x00F8(0x0010)(Edit, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FValueOrBBKey_Bool                     bRequireNavigableEndLocation;                      // 0x0108(0x0010)(Edit, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FValueOrBBKey_Bool                     bProjectGoalLocation;                              // 0x0118(0x0010)(Edit, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FValueOrBBKey_Bool                     bReachTestIncludesAgentRadius;                     // 0x0128(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FValueOrBBKey_Bool                     bReachTestIncludesGoalRadius;                      // 0x0138(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FValueOrBBKey_Bool                     bStartFromPreviousPath;                            // 0x0148(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         BitPad_158_0 : 1;                                  // 0x0158(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bObserveBlackboardValue : 1;                       // 0x0158(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
{
public:
	struct FValueOrBBKey_Object                   AnimationToPlay;                                   // 0x0070(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	class UBehaviorTreeComponent*                 MyOwnerComp;                                       // 0x00B0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class USkeletalMeshComponent*                 CachedSkelMesh;                                    // 0x00B8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
{
public:
	struct FValueOrBBKey_Object                   SoundToPlay;                                       // 0x0070(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	struct FValueOrBBKey_Float                    Precision;                                         // 0x0098(0x0010)(Edit, Config, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
{
public:
	class UBehaviorTree*                          BehaviorAsset;                                     // 0x0070(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	...
	class UBehaviorTree*                          DefaultBehaviorAsset;                              // 0x0078(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	class UBehaviorTree*                          BehaviorAsset;                                     // 0x0080(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
{
public:
	bool                                          bUseBBKey;                                         // 0x0098(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_99[0x7];                                       // 0x0099(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEQSParametrizedQueryExecutionRequest  EQSRequest;                                        // 0x00A0(0x0048)(Edit, NativeAccessSpecifierPublic)
	bool                                          bUpdateBBOnFail;                                   // 0x00E8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Class AIModule.BTTask_SetKeyValueBool
// 0x0010 (0x00A8 - 0x0098)
class UBTTask_SetKeyValueBool final : public UBTTask_BlackboardBase
{
public:
	struct FValueOrBBKey_Bool                     Value;                                             // 0x0098(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPrivate)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("BTTask_SetKeyValueBool")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BTTask_SetKeyValueBool")
	}
	static class UBTTask_SetKeyValueBool* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBTTask_SetKeyValueBool>();
	}
};
DUMPER7_ASSERTS_UBTTask_SetKeyValueBool;

// Class AIModule.BTTask_SetKeyValueClass
// 0x0028 (0x00C0 - 0x0098)
class UBTTask_SetKeyValueClass final : public UBTTask_BlackboardBase
{
public:
	TSubclassOf<class UObject>                    BaseClass;                                         // 0x0098(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FValueOrBBKey_Class                    Value;                                             // 0x00A0(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPrivate)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("BTTask_SetKeyValueClass")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BTTask_SetKeyValueClass")
	}
	static class UBTTask_SetKeyValueClass* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBTTask_SetKeyValueClass>();
	}
};
DUMPER7_ASSERTS_UBTTask_SetKeyValueClass;

// Class AIModule.BTTask_SetKeyValueEnum
// 0x0030 (0x00C8 - 0x0098)
class UBTTask_SetKeyValueEnum final : public UBTTask_BlackboardBase
{
public:
	class UEnum*                                  EnumType;                                          // 0x0098(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	struct FValueOrBBKey_Enum                     Value;                                             // 0x00A0(0x0028)(Edit, NativeAccessSpecifierPrivate)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("BTTask_SetKeyValueEnum")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BTTask_SetKeyValueEnum")
	}
	static class UBTTask_SetKeyValueEnum* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBTTask_SetKeyValueEnum>();
	}
};
DUMPER7_ASSERTS_UBTTask_SetKeyValueEnum;

// Class AIModule.BTTask_SetKeyValueInt32
// 0x0010 (0x00A8 - 0x0098)
class UBTTask_SetKeyValueInt32 final : public UBTTask_BlackboardBase
{
public:
	struct FValueOrBBKey_Int32                    Value;                                             // 0x0098(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BTTask_SetKeyValueInt32")
	}
	static class UBTTask_SetKeyValueInt32* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBTTask_SetKeyValueInt32>();
	}
};
DUMPER7_ASSERTS_UBTTask_SetKeyValueInt32;

// Class AIModule.BTTask_SetKeyValueFloat
// 0x0010 (0x00A8 - 0x0098)
class UBTTask_SetKeyValueFloat final : public UBTTask_BlackboardBase
{
public:
	struct FValueOrBBKey_Float                    Value;                                             // 0x0098(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
...
public:
	...
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BTTask_SetKeyValueFloat")
	}
	static class UBTTask_SetKeyValueFloat* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBTTask_SetKeyValueFloat>();
	}
};
DUMPER7_ASSERTS_UBTTask_SetKeyValueFloat;

// Class AIModule.BTTask_SetKeyValueName
// 0x0018 (0x00B0 - 0x0098)
class UBTTask_SetKeyValueName final : public UBTTask_BlackboardBase
{
public:
	struct FValueOrBBKey_Name                     Value;                                             // 0x0098(0x0014)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_AC[0x4];                                       // 0x00AC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("BTTask_SetKeyValueName")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BTTask_SetKeyValueName")
	}
	static class UBTTask_SetKeyValueName* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBTTask_SetKeyValueName>();
	}
};
DUMPER7_ASSERTS_UBTTask_SetKeyValueName;

// Class AIModule.BTTask_SetKeyValueString
// 0x0020 (0x00B8 - 0x0098)
class UBTTask_SetKeyValueString final : public UBTTask_BlackboardBase
{
public:
	struct FValueOrBBKey_String                   Value;                                             // 0x0098(0x0020)(Edit, NativeAccessSpecifierPrivate)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("BTTask_SetKeyValueString")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BTTask_SetKeyValueString")
	}
	static class UBTTask_SetKeyValueString* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBTTask_SetKeyValueString>();
	}
};
DUMPER7_ASSERTS_UBTTask_SetKeyValueString;

// Class AIModule.BTTask_SetKeyValueObject
// 0x0028 (0x00C0 - 0x0098)
class UBTTask_SetKeyValueObject final : public UBTTask_BlackboardBase
{
public:
	TSubclassOf<class UObject>                    BaseClass;                                         // 0x0098(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FValueOrBBKey_Object                   Value;                                             // 0x00A0(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPrivate)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("BTTask_SetKeyValueObject")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BTTask_SetKeyValueObject")
	}
	static class UBTTask_SetKeyValueObject* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBTTask_SetKeyValueObject>();
	}
};
DUMPER7_ASSERTS_UBTTask_SetKeyValueObject;

// Class AIModule.BTTask_SetKeyValueRotator
// 0x0028 (0x00C0 - 0x0098)
class UBTTask_SetKeyValueRotator final : public UBTTask_BlackboardBase
{
public:
	struct FValueOrBBKey_Rotator                  Value;                                             // 0x0098(0x0028)(Edit, NoDestructor, NativeAccessSpecifierPrivate)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("BTTask_SetKeyValueRotator")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BTTask_SetKeyValueRotator")
	}
	static class UBTTask_SetKeyValueRotator* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBTTask_SetKeyValueRotator>();
	}
};
DUMPER7_ASSERTS_UBTTask_SetKeyValueRotator;

// Class AIModule.BTTask_SetKeyValueStruct
// 0x0028 (0x00C0 - 0x0098)
class UBTTask_SetKeyValueStruct final : public UBTTask_BlackboardBase
{
public:
	class UScriptStruct*                          StructType;                                        // 0x0098(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	struct FValueOrBBKey_Struct                   Value;                                             // 0x00A0(0x0020)(Edit, NativeAccessSpecifierPrivate)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("BTTask_SetKeyValueStruct")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BTTask_SetKeyValueStruct")
	}
	static class UBTTask_SetKeyValueStruct* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBTTask_SetKeyValueStruct>();
	}
};
DUMPER7_ASSERTS_UBTTask_SetKeyValueStruct;

// Class AIModule.BTTask_SetKeyValueVector
// 0x0028 (0x00C0 - 0x0098)
class UBTTask_SetKeyValueVector final : public UBTTask_BlackboardBase
{
public:
	struct FValueOrBBKey_Vector                   Value;                                             // 0x0098(0x0028)(Edit, NoDestructor, NativeAccessSpecifierPrivate)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("BTTask_SetKeyValueVector")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BTTask_SetKeyValueVector")
	}
	static class UBTTask_SetKeyValueVector* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBTTask_SetKeyValueVector>();
	}
};
DUMPER7_ASSERTS_UBTTask_SetKeyValueVector;
...
public:
	...
	struct FValueOrBBKey_Bool                     bAddToExistingDuration;                            // 0x0078(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FValueOrBBKey_Float                    CooldownDuration;                                  // 0x0088(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	struct FValueOrBBKey_Float                    WaitTime;                                          // 0x0070(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	struct FBlackboardKeySelector                 BlackboardKey;                                     // 0x0090(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
...
// 0x0000 (0x0028 - 0x0028)
class UValueOrBBKeyBlueprintUtility final : public UBlueprintFunctionLibrary
{
public:
	static bool GetBool(const struct FValueOrBBKey_Bool& Value, const class UBehaviorTreeComponent* BehaviorTreeComp);
	static class UClass* GetClass(const struct FValueOrBBKey_Class& Value, const class UBehaviorTreeComponent* BehaviorTreeComp);
	static uint8 GetEnum(const struct FValueOrBBKey_Enum& Value, const class UBehaviorTreeComponent* BehaviorTreeComp);
	static float GetFloat(const struct FValueOrBBKey_Float& Value, const class UBehaviorTreeComponent* BehaviorTreeComp);
	static int32 GetInt32(const struct FValueOrBBKey_Int32& Value, const class UBehaviorTreeComponent* BehaviorTreeComp);
	static class FName GetName(const struct FValueOrBBKey_Name& Value, const class UBehaviorTreeComponent* BehaviorTreeComp);
	static class UObject* GetObject(const struct FValueOrBBKey_Object& Value, const class UBehaviorTreeComponent* BehaviorTreeComp);
	static struct FRotator GetRotator(const struct FValueOrBBKey_Rotator& Value, const class UBehaviorTreeComponent* BehaviorTreeComp);
	static class FString GetString(const struct FValueOrBBKey_String& Value, const class UBehaviorTreeComponent* BehaviorTreeComp);
	static struct FInstancedStruct GetStruct(const struct FValueOrBBKey_Struct& Value, const class UBehaviorTreeComponent* BehaviorTreeComp);
	static struct FVector GetVector(const struct FValueOrBBKey_Vector& Value, const class UBehaviorTreeComponent* BehaviorTreeComp);

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("ValueOrBBKeyBlueprintUtility")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ValueOrBBKeyBlueprintUtility")
	}
	static class UValueOrBBKeyBlueprintUtility* GetDefaultObj()
	{
		return GetDefaultObjImpl<UValueOrBBKeyBlueprintUtility>();
	}
};
DUMPER7_ASSERTS_UValueOrBBKeyBlueprintUtility;
...
{
public:
	float                                         min_0;                                             // 0x0040(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         max_0;                                             // 0x0044(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	TArray<class UAIPerceptionComponent*>         ListenerContainer;                                 // 0x0080(0x0010)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	TArray<class UAISenseEvent*>                  UnprocessedEvents;                                 // 0x0090(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
...
// Class AIModule.EnvQueryContext_NavigationData
// 0x0038 (0x0060 - 0x0028)
class UEnvQueryContext_NavigationData final : public UEnvQueryContext
{
public:
	struct FNavAgentProperties                    NavAgentProperties;                                // 0x0028(0x0038)(Edit, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("EnvQueryContext_NavigationData")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"EnvQueryContext_NavigationData")
	}
	static class UEnvQueryContext_NavigationData* GetDefaultObj()
	{
		return GetDefaultObjImpl<UEnvQueryContext_NavigationData>();
	}
};
DUMPER7_ASSERTS_UEnvQueryContext_NavigationData;
...
{
public:
	TArray<class UAISenseConfig*>                 SensesConfig;                                      // 0x00C0(0x0010)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	TSubclassOf<class UAISense>                   DominantSense;                                     // 0x00D0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_D8[0x10];                                      // 0x00D8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class AAIController*                          AIOwner;                                           // 0x00E8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	...
	TMulticastInlineDelegate<void(class AActor* Actor)> OnTargetPerceptionForgotten;                 // 0x0180(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class AActor* Actor, const struct FAIStimulus& Stimulus)> OnTargetPerceptionUpdated; // 0x0190(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FActorPerceptionUpdateInfo& UpdateInfo)> OnTargetPerceptionInfoUpdated; // 0x01A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<class UEnvQueryOption*>                Options;                                           // 0x0038(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	...
	uint8                                         bCanRunAsync : 1;                                  // 0x0048(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_49[0x3];                                       // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	EEnvQueryResultNormalizationOption            EnvQueryResultNormalizationOption;                 // 0x004C(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4D[0x3];                                       // 0x004D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	TArray<class UEnvQueryContext*>               LocalContexts;                                     // 0x00B8(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	TArray<class UEnvQueryInstanceBlueprintWrapper*> GCShieldedWrappers;                             // 0x00C8(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
...
{
public:
	class UEnvQueryGenerator*                     Generator;                                         // 0x0028(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	TArray<class UEnvQueryTest*>                  Tests;                                             // 0x0030(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
...
public:
	...
	class UEnvQuery*                              QueryTemplate;                                     // 0x0650(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	TArray<struct FEnvNamedValue>                 QueryParams;                                       // 0x0658(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FAIDynamicParam>                QueryConfig;                                       // 0x0668(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         TimeLimitPerStep;                                  // 0x0678(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         StepToDebugDraw;                                   // 0x067C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EEnvQueryHightlightMode                       HighlightMode;                                     // 0x0680(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_681[0x3];                                      // 0x0681(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bDrawLabels : 1;                                   // 0x0684(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDrawFailedItems : 1;                              // 0x0684(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReRunQueryOnlyOnFinishedMove : 1;                 // 0x0684(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bShouldBeVisibleInGame : 1;                        // 0x0684(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bTickDuringGame : 1;                               // 0x0684(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bRunQueryOnSelectionChanged : 1;                   // 0x0684(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_685[0x3];                                      // 0x0685(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	EEnvQueryRunMode                              QueryingMode;                                      // 0x0688(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_689[0x7];                                      // 0x0689(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNavAgentProperties                    NavAgentProperties;                                // 0x0690(0x0038)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6C8[0x10];                                     // 0x06C8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FEnvQueryInstance>              StepResults;                                       // 0x06D8(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
...
{
public:
	TArray<class UEnvQueryGenerator*>             Generators;                                        // 0x0050(0x0010)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
...
public:
	...
	TSubclassOf<class UEnvQueryContext>           NavDataOverrideContext;                            // 0x0090(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FAIDataProviderFloatValue              AlignedPointsDistance;                             // 0x0098(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FAIDataProviderFloatValue              ConeDegrees;                                       // 0x00D0(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FAIDataProviderFloatValue              AngleStep;                                         // 0x0108(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FAIDataProviderFloatValue              Range;                                             // 0x0140(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TSubclassOf<class UEnvQueryContext>           CenterActor;                                       // 0x0178(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         bIncludeContextLocation : 1;                       // 0x0180(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
// 0x0008 (0x00A0 - 0x0098)
class UEnvQueryGenerator_CurrentLocation final : public UEnvQueryGenerator_ProjectedPoints
{
public:
	TSubclassOf<class UEnvQueryContext>           QueryContext;                                      // 0x0098(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	struct FEnvDirection                          ArcDirection;                                      // 0x0178(0x0020)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	...
	bool                                          bUseSpiralPattern;                                 // 0x01D0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FAIDataProviderFloatValue              CircleRadius;                                      // 0x0098(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	EPointOnCircleSpacingMethod                   PointOnCircleSpacingMethod;                        // 0x00D0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TSubclassOf<class UEnvQueryContext>           CircleCenter;                                      // 0x01D8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIgnoreAnyContextActorsWhenGeneratingCircle;       // 0x01E0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E1[0x7];                                      // 0x01E1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAIDataProviderFloatValue              CircleCenterZOffset;                               // 0x01E8(0x0038)(Edit, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FEnvTraceData                          TraceData;                                         // 0x0220(0x0040)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         bDefineArc : 1;                                    // 0x0260(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
public:
	...
	TSubclassOf<class UEnvQueryContext>           GenerateAround;                                    // 0x0108(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TSubclassOf<class UNavigationQueryFilter>     NavigationFilter;                                  // 0x0148(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FAIDataProviderFloatValue              ScanRangeMultiplier;                               // 0x0150(0x0038)(Edit, DisableEditOnInstance, ContainsInstancedReference, AdvancedDisplay, NativeAccessSpecifierPublic)
...
public:
	...
	bool                                          bSearchComponentsForTags;                          // 0x0240(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bRejectIncompatibleItems;                          // 0x0241(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUpdatedToUseQuery;                                // 0x0242(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EGameplayContainerMatchType                   TagsToMatch;                                       // 0x0243(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	class ANavigationData*                        MyNavData;                                         // 0x0028(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
{
public:
	class UNavLocalGridManager*                   GridManager;                                       // 0x0310(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	...
	class UNavLinkCustomComponent*                SmartLinkComp;                                     // 0x02E0(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	TArray<class UAISense*>                       Senses;                                            // 0x0088(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
